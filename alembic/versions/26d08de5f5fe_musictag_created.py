...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_music_tag_user_id_users'), ondelete='CASCADE'),
    ...
    op.create_foreign_key(op.f('fk_music_tag_id_music_tag'), 'music', 'music_tag', ['tag_id'], ['id'], ondelete='CASCADE')
